                        ...
                        <div className="bg-[#1a2332] p-6 rounded-xl shadow-xl sticky top-6 border border-[#6090A0] transition-colors duration-300">
                            <div className="flex justify-between items-center mb-4">
                                <h2 className="text-xl font-bold flex items-center gap-2">
                                    <FaEdit className="text-amber-400" /> Modifier l'employé
                                </h2>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div>
                                    ...
                                    <input type="number" min="0" step={"1"} required className={inputStyle} value={formData.salaire ?? 0} onChange={e => setFormData({ ...formData, salaire: Number(e.target.value) })} />
                                </div>
